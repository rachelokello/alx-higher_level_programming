This readme has the following files
1. 0-rectangle.py- Write an empty class Rectangle that defines a rectangle:
...
4. 3-rectangle.py- Write a class Rectangle that defines a rectangle by: (based on 2-rectangle.py)
